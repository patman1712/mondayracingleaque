...
const schema = z.object({
  ...
  entries: z.array(
    z.object({
      ...
      sector1: z.string().optional(),
      sector2: z.string().optional(),
      sector3: z.string().optional(),
      sector1Color: z.string().optional(),
      sector2Color: z.string().optional(),
      sector3Color: z.string().optional(),
      drs: z.boolean().optional(),
      ers: z.number().optional(),
      tyre: z.string().optional(),
      x: z.number().optional(),
      y: z.number().optional(),
      z: z.number().optional(),
